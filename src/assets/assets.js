...
export const aboutInfo = [
    ...
    },
    {
      ...
      description: 'I thrive on tackling challenges head‑on, analyzing issues deeply, and delivering efficient, scalable solutions.',
      color: 'text-blue-500'
},
...
export const workData = [
  {
    ...
    description:
      "Leading React development for enterprise clients, implementing modern frameworks, and mentoring junior developers.",
    color: "purple"
  },
  {
    role: "Web Developer Intern",
    company: "Softhub Technology",
    duration: "2022 - 2023",
    description:
